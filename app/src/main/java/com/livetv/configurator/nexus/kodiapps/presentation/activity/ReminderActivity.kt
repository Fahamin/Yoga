...
import com.livetv.configurator.nexus.kodiapps.adapter.ReminderAdapter
...
import com.livetv.configurator.nexus.kodiapps.databinding.ActivityReminderBinding
import com.livetv.configurator.nexus.kodiapps.model.ReminderTableClass
import com.livetv.configurator.nexus.kodiapps.reminder.AlarmReceiver
import com.livetv.configurator.nexus.kodiapps.reminder.Reminder
import com.livetv.configurator.nexus.kodiapps.reminder.ReminderDatabase
        ...
        builder.setPositiveButton(R.string.btn_ok) { dialog, which ->
            ...
            if (isFromEdit) {
                ...
                if (arrayList.size == 0) {
                    ...
                    pref.setPref(Constant.PREF_IS_REMINDER_SET, true)
                }
                fillData()
                setResult(Activity.RESULT_OK)
                dialog.dismiss()
