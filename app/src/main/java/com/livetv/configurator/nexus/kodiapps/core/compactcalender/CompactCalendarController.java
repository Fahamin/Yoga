package com.livetv.configurator.nexus.kodiapps.core.compactcalender;


import static com.livetv.configurator.nexus.kodiapps.core.compactcalender.CompactCalendarView.FILL_LARGE_INDICATOR;
import static com.livetv.configurator.nexus.kodiapps.core.compactcalender.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static com.livetv.configurator.nexus.kodiapps.core.compactcalender.CompactCalendarView.SMALL_INDICATOR;
        ...
        for (int dayColumn = 0, colDirection = isRtl ? 6 : 0, dayRow = 0; dayColumn <= 6; dayRow++) {
            ...
            if (dayRow == 0) {
                ...
                if (day <= 0) {
                    ...
                    @SuppressLint("DefaultLocale") String strDate = (monthToDrawCalender.get(Calendar.YEAR)
